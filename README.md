...
The most important finding of our unsupervised learning effort is that our algoirthm perfectly clusters the data points according to the target values. That is, although we do not provide any information regarding the target value, the unsupervised algorithm clusters the data points according to increasing LOS values. Following is the assignment of each cluster to a specific LOS interval:
...
Due to the data collection period coincides with the COVID-19 pandemic, we witness the undeniable impact of the disease on the types of admitted patients. We see that different severities of COVID-19 admissions dominate the clusters from 1 to 6. For example, in Cluster 2 and 4, the most frequent admissions are the moderate and major cases of COVID-19, where patients receive regular COVID-19 therapies and stay at the hospital between 2 and 12 days. While the most frequent LOS for Cluster 4 which corresponds to the moderate severity of illness is 4 days, the value goes up to 7 days for major severities. Moreover, clusters 1, 3 and 5 higlights the extreme cases of COVID-19 in terms of severity of illness and risk of mortality. The COVID-19 patients in these three clusters mostly require a mechanical ventilation treatment and account for an LOS which ranges from 13 to 65. The COVID-19 patients in Cluster 1 and 5 share similar feature values and belongs to the All Patients Refined Diagnosis Related Groups (APR-DRG) of SEPTICEMIA AND DISSEMINATED INFECTIONS. While the patients in Cluster 5 are mostly 70 years old or order and stays at the hospital for around 13 days, Cluster 1 patients are mostly between 50 and 69 years old and have an LOS of around 23. COVID-19 patients of Cluster 3 differ from Cluster 1 and 5 patients in terms of their APR-DRG which is TRACHEOSTOMY WITH MV >96 HOURS WITHOUT EXTENSIVE PROCEDURE. This difference in APR-DRG leads to a longer stay at the hospital with the most frequent number of 39 days. Furthermore, Cluster 6 covers the most extreme cases of COVID-19 patients which require a TRACHEOSTOMY surgery and stay at the hospital much more than other COVID-19 patients to recover from the operation. These patients stay at the hospital most frequently for 67 days. Finally, Cluster 0 patients denotes a different yet the most condensed type of admission in our records, which is childbirth. Due to nature of the admissin type, most of the patient in the cluster are female and between 30 and 49 years old. Because of the lower severity and mortality risk of the process, patients stay at the hospital between 1 and 3 days (most frequently 2 days).

Through our unsupervised learning efforts, we show that hospital managers can differentiate, first between childbird and COVID-19 admissions, and further among different tpyes of COVID-19 admissions with respect to severity of illness, risk of mortality, treatment procedure and APR-DRG description to obtain a rough estimate for the LOS, and take quick actions for planning and resource allocations if needed. However, for a more precise prediction of LOS covering all type of admissions (not only childbird and COVID-19), managers can utilize our supervised learning algorithm.
